...
func (ml *MoneyLiteral) String() string       { return ml.Token.Literal }
...
func (fl *FunctionLiteral) String() string       { return "function" }
...
func (ce *CallExpression) String() string       { return "call" }
...
func (ie *IndexExpression) String() string       { return "index" }
